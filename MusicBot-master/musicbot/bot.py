...
class MusicBot(discord.Client):
    ...
    # TODO: autojoin option to a specific channel
        ...
        if server.id not in self.players:
            if not create:
                raise exceptions.CommandError(
                    ...
                    'Use %join to join it to your voice channel.' % self.config.command_prefix)
    ...
    async def on_ready(self):
        ...
        if self.config.autojoin_channels:
            ...
            print("Attempting to autojoin...", flush=True)
            ...
            if owner_vc:
                ...
                print("Owner not found in a voice channel, could not autojoin.")
    ...
    async def cmd_disconnect(self, server):
        ...
        return Response("Senpai! Are you cheating on me?:broken_heart:", delete_after=10)
    ...
    async def cmd_shutdown(self, channel):
        await self.safe_send_message(channel, "``Shutingdown...``")
        await self.disconnect_all_voice_clients()
